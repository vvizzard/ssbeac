...
import 'package:argon_flutter/screens/producteurFoyerModifcation.dart';
...
class ListeProducteurFoyer extends StatefulWidget {
  @override
  _ListeProducteurFoyerState createState() => _ListeProducteurFoyerState();
}

class _ListeProducteurFoyerState extends State<ListeProducteurFoyer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: Navbar(
          title: "ProducteurFoyers",
          rightOptions: false,
        ),
        backgroundColor: ArgonColors.bgColorScreen,
        drawer: ArgonDrawer(currentPage: "ProducteurFoyers"),
                          ...
                          TextButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ProducteurFoyerModification(
                                    productionFoyerEnCours: ProducteurFEntity.fromMap(e),
                                  ),
                                ),
                              );
                            },
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      csvHelper.generateCsv(data[1][0]+'_producteur_foyer_'+dateFormat.format(new DateTime.now())+'.csv', data);
                    });
