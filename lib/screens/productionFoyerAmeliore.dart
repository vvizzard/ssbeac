...
class ProductionFoyerAmeliore extends StatefulWidget {
  @override
  _ProductionFoyerAmelioreState createState() => _ProductionFoyerAmelioreState();
}

class _ProductionFoyerAmelioreState extends State<ProductionFoyerAmeliore> {
  ...
  String typeBEChoosed;
  String typeFABCChoosed;
  String typeFACBChoosed;
  ...
  ProductionFoyerAmelioreEntity ds = new ProductionFoyerAmelioreEntity();
  ...
  _save() {
    ...
    ds.agg = agg.text;
    ds.boisEnergie = typeBEChoosed;
    ds.foyerBC = typeFABCChoosed;
    ds.foyerCB = typeFACBChoosed;
    ds.production = double.tryParse(production.text);
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: DropdownButton<String>(
                  ...
                  value: typeFABCChoosed,
                  isExpanded: true,
                  onChanged: (String newValue) {
                    setState(() {
                      typeFABCChoosed = newValue;
                    });
                  },
                  items: listeFABC
                      .map<DropdownMenuItem<String>>((String value) {
              ...
              Padding(
                ...
                child: DropdownButton<String>(
                  ...
                  value: typeFACBChoosed,
                  isExpanded: true,
                  onChanged: (String newValue) {
                    setState(() {
                      typeFACBChoosed = newValue;
                    });
                  },
                  items: listeFACB
                      .map<DropdownMenuItem<String>>((String value) {
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacementNamed(context, '/listeproductionfa');
                      _save();
                    },
